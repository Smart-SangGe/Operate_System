...
static int __init write_disk_init(void)
{
    ...
    int write_time;
    loff_t pos;
    printk("Group 10, Start write_to_disk module...\n");
    ...
    printk(KERN_ALERT "Group 10, Writing to file costs %d us\n", write_time);
    printk("Group 10, Writing speed is %d M/s\n", buf_size * write_times / write_time);
    return 0;
}
static void __exit write_disk_exit(void)
{
    printk("Group 10, Exit write_to_disk module...\n");
}
